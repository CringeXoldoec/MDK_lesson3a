<div class="registration-cssave">
    ...
    @csrf
        ...
        <div class="form-group">
            <input class="form-control item" value="{{ old("name")}}" type="text" name="name" maxlength="15" minlength="4" autofocus pattern="^[a-zA-Z0-9_.-]*$" id="username" placeholder="Имя пользователя" required >
            @error('name')
                <span class="error">
                    {{$message}}
                </span>
        ...
        <div class="form-group">
            <input class="form-control item" value="{{ old("email")}}" type="email" name="email" id="email" placeholder="Email" required
            @error('email')
                <span class="error">
                    {{$message}}
                </span>
        ...
        <div class="form-group">
            <input class="form-control item" type="password" name="password_confirmation" minlength="8" id="password_confirmation" placeholder="Подтвердите пароль" required>
